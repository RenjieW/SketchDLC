...
/*=========== used to record the push_pull_operation=============*/
...
//=================== xym add this 2017-12-11 ===============//
  pb.set_push_pull_operation(meta.push_pull_operation);
//=================== xym add this 2017-12-11 ===============//
//=================== xym add this 2018-01-02 ===============//
  pb.set_recv_key(meta.recv_key);
//=================== xym add this 2018-01-02 ===============//
...
void Van::UnpackMeta(const char* meta_buf, int buf_size, Meta* meta) {
  ...
  meta->body = pb.body();
//================== xym add this 2017-12-11 =========//
  meta->push_pull_operation = pb.push_pull_operation();
//================== xym add this 2017-12-11 =========//
//================== xym add this 2018-01-02 =========//
  meta->recv_key = pb.recv_key();
//================== xym add this 2018-01-02 =========//
